...
type RequestRegisterAvroraPushToken struct {
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
}

func (m *RequestRegisterAvroraPushToken) Reset()      { *m = RequestRegisterAvroraPushToken{} }
func (*RequestRegisterAvroraPushToken) ProtoMessage() {}
func (*RequestRegisterAvroraPushToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_d1e4bfd2e9d102bb, []int{8}
}
func (m *RequestRegisterAvroraPushToken) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestRegisterAvroraPushToken) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestRegisterAvroraPushToken.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestRegisterAvroraPushToken) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestRegisterAvroraPushToken.Merge(m, src)
}
func (m *RequestRegisterAvroraPushToken) XXX_Size() int {
	return m.Size()
}
func (m *RequestRegisterAvroraPushToken) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestRegisterAvroraPushToken.DiscardUnknown(m)
}

var xxx_messageInfo_RequestRegisterAvroraPushToken proto.InternalMessageInfo

func (m *RequestRegisterAvroraPushToken) GetToken() string {
	if m != nil {
		return m.Token
	}
	return ""
...
type RequestUnregisterAvroraPushToken struct {
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
}

func (m *RequestUnregisterAvroraPushToken) Reset()      { *m = RequestUnregisterAvroraPushToken{} }
func (*RequestUnregisterAvroraPushToken) ProtoMessage() {}
func (*RequestUnregisterAvroraPushToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_d1e4bfd2e9d102bb, []int{9}
}
func (m *RequestUnregisterAvroraPushToken) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestUnregisterAvroraPushToken) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestUnregisterAvroraPushToken.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestUnregisterAvroraPushToken) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestUnregisterAvroraPushToken.Merge(m, src)
}
func (m *RequestUnregisterAvroraPushToken) XXX_Size() int {
	return m.Size()
}
func (m *RequestUnregisterAvroraPushToken) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestUnregisterAvroraPushToken.DiscardUnknown(m)
}

var xxx_messageInfo_RequestUnregisterAvroraPushToken proto.InternalMessageInfo

func (m *RequestUnregisterAvroraPushToken) GetToken() string {
	if m != nil {
		return m.Token
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*RequestRegisterAvroraPushToken)(nil), "dialog.RequestRegisterAvroraPushToken")
	proto.RegisterType((*RequestUnregisterAvroraPushToken)(nil), "dialog.RequestUnregisterAvroraPushToken")
}
...
var fileDescriptor_d1e4bfd2e9d102bb = []byte{
	...
	,
}
...
func (this *RequestRegisterAvroraPushToken) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*RequestRegisterAvroraPushToken)
	if !ok {
		that2, ok := that.(RequestRegisterAvroraPushToken)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *RequestUnregisterAvroraPushToken) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*RequestUnregisterAvroraPushToken)
	if !ok {
		that2, ok := that.(RequestUnregisterAvroraPushToken)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *RequestRegisterAvroraPushToken) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&dialog.RequestRegisterAvroraPushToken{")
	s = append(s, "Token: "+fmt.Sprintf("%#v", this.Token)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *RequestUnregisterAvroraPushToken) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&dialog.RequestUnregisterAvroraPushToken{")
	s = append(s, "Token: "+fmt.Sprintf("%#v", this.Token)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
type PushClient interface {
	...
	RegisterAvroraPushToken(ctx context.Context, in *RequestRegisterAvroraPushToken, opts ...grpc.CallOption) (*ResponseVoid, error)
	UnregisterAvroraPushToken(ctx context.Context, in *RequestUnregisterAvroraPushToken, opts ...grpc.CallOption) (*ResponseVoid, error)
}
...
func (c *pushClient) RegisterAvroraPushToken(ctx context.Context, in *RequestRegisterAvroraPushToken, opts ...grpc.CallOption) (*ResponseVoid, error) {
	out := new(ResponseVoid)
	err := c.cc.Invoke(ctx, "/dialog.Push/RegisterAvroraPushToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pushClient) UnregisterAvroraPushToken(ctx context.Context, in *RequestUnregisterAvroraPushToken, opts ...grpc.CallOption) (*ResponseVoid, error) {
	out := new(ResponseVoid)
	err := c.cc.Invoke(ctx, "/dialog.Push/UnregisterAvroraPushToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PushServer interface {
	...
	RegisterAvroraPushToken(context.Context, *RequestRegisterAvroraPushToken) (*ResponseVoid, error)
	UnregisterAvroraPushToken(context.Context, *RequestUnregisterAvroraPushToken) (*ResponseVoid, error)
}
...
func (*UnimplementedPushServer) RegisterAvroraPushToken(ctx context.Context, req *RequestRegisterAvroraPushToken) (*ResponseVoid, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterAvroraPushToken not implemented")
}
func (*UnimplementedPushServer) UnregisterAvroraPushToken(ctx context.Context, req *RequestUnregisterAvroraPushToken) (*ResponseVoid, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnregisterAvroraPushToken not implemented")
}
...
func _Push_RegisterAvroraPushToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestRegisterAvroraPushToken)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PushServer).RegisterAvroraPushToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dialog.Push/RegisterAvroraPushToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PushServer).RegisterAvroraPushToken(ctx, req.(*RequestRegisterAvroraPushToken))
	}
	return interceptor(ctx, in, info, handler)
}

func _Push_UnregisterAvroraPushToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestUnregisterAvroraPushToken)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PushServer).UnregisterAvroraPushToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dialog.Push/UnregisterAvroraPushToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PushServer).UnregisterAvroraPushToken(ctx, req.(*RequestUnregisterAvroraPushToken))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Push_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RegisterAvroraPushToken",
			Handler:    _Push_RegisterAvroraPushToken_Handler,
		},
		{
			MethodName: "UnregisterAvroraPushToken",
			Handler:    _Push_UnregisterAvroraPushToken_Handler,
		},
	},
...
func (m *RequestRegisterAvroraPushToken) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestRegisterAvroraPushToken) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestRegisterAvroraPushToken) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RequestUnregisterAvroraPushToken) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestUnregisterAvroraPushToken) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestUnregisterAvroraPushToken) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RequestRegisterAvroraPushToken) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestUnregisterAvroraPushToken) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *RequestRegisterAvroraPushToken) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RequestRegisterAvroraPushToken{`,
		`Token:` + fmt.Sprintf("%v", this.Token) + `,`,
		`}`,
	}, "")
	return s
}
func (this *RequestUnregisterAvroraPushToken) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RequestUnregisterAvroraPushToken{`,
		`Token:` + fmt.Sprintf("%v", this.Token) + `,`,
		`}`,
	}, "")
	return s
...
func (m *RequestRegisterAvroraPushToken) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestRegisterAvroraPushToken: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestRegisterAvroraPushToken: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RequestUnregisterAvroraPushToken) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestUnregisterAvroraPushToken: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestUnregisterAvroraPushToken: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
