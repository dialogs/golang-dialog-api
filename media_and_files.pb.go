...
type FileUrlDescription struct {
	...
	Md5Hash            []byte        `protobuf:"bytes,6,opt,name=md5_hash,json=md5Hash,proto3" json:"md5_hash,omitempty"`
}
...
func (m *FileUrlDescription) GetMd5Hash() []byte {
	if m != nil {
		return m.Md5Hash
	}
	return nil
...
type ResponseGetFileUrl struct {
	...
	Md5Hash            []byte             `protobuf:"bytes,5,opt,name=md5_hash,json=md5Hash,proto3" json:"md5_hash,omitempty"`
}
...
func (m *ResponseGetFileUrl) GetMd5Hash() []byte {
	if m != nil {
		return m.Md5Hash
	}
	return nil
...
func (m *RequestCommitFileUpload) GetMd5Hash() []byte {
	if m != nil {
		return m.Md5Hash
	}
	return nil
...
var fileDescriptor_da878b320292c477 = []byte{
	...
	,
}
...
func (this *FileUrlDescription) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.Md5Hash, that1.Md5Hash) {
		return false
	}
	return true
}
...
func (m *FileUrlDescription) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Md5Hash) > 0 {
		...
		i = encodeVarintMediaAndFiles(dAtA, i, uint64(len(m.Md5Hash)))
		i--
		dAtA[i] = 0x32
	}
...
func (m *FileUrlDescription) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.Md5Hash = append(m.Md5Hash[:0], dAtA[iNdEx:postIndex]...)
			if m.Md5Hash == nil {
				m.Md5Hash = []byte{}
			}
			iNdEx = postIndex
