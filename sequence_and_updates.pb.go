...
type UpdateSeqUpdate struct {
	...
	//	*UpdateSeqUpdate_UpdateGroupTyping
	//	*UpdateSeqUpdate_UpdateDialogReadLaterChanged
...
type UpdateSeqUpdate_UpdateGroupTyping struct {
	UpdateGroupTyping *UpdateGroupTyping `protobuf:"bytes,102,opt,name=updateGroupTyping,proto3,oneof" json:"updateGroupTyping,omitempty"`
}
type UpdateSeqUpdate_UpdateDialogReadLaterChanged struct {
	UpdateDialogReadLaterChanged *UpdateDialogReadLaterChanged `protobuf:"bytes,103,opt,name=updateDialogReadLaterChanged,proto3,oneof" json:"updateDialogReadLaterChanged,omitempty"`
}
...
func (*UpdateSeqUpdate_UpdateGroupTyping) isUpdateSeqUpdate_Update()                   {}
func (*UpdateSeqUpdate_UpdateDialogReadLaterChanged) isUpdateSeqUpdate_Update()        {}
...
func (m *UpdateSeqUpdate) GetUpdateGroupTyping() *UpdateGroupTyping {
	if x, ok := m.GetUpdate().(*UpdateSeqUpdate_UpdateGroupTyping); ok {
		return x.UpdateGroupTyping
	}
	return nil
}

func (m *UpdateSeqUpdate) GetUpdateDialogReadLaterChanged() *UpdateDialogReadLaterChanged {
	if x, ok := m.GetUpdate().(*UpdateSeqUpdate_UpdateDialogReadLaterChanged); ok {
		return x.UpdateDialogReadLaterChanged
	}
	return nil
}
...
func (*UpdateSeqUpdate) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*UpdateSeqUpdate_UpdateGroupTyping)(nil),
		(*UpdateSeqUpdate_UpdateDialogReadLaterChanged)(nil),
	}
}
...
type RequestSubscribeToGroupOnline struct {
	...
	SendUsersId bool `protobuf:"varint,2,opt,name=send_users_id,json=sendUsersId,proto3" json:"send_users_id,omitempty"`
}
...
func (m *RequestSubscribeToGroupOnline) GetSendUsersId() bool {
	if m != nil {
		return m.SendUsersId
	}
	return false
}
...
type WeakUpdateCommand struct {
	...
	//	*WeakUpdateCommand_SubscribeToOnlines_
...
type WeakUpdateCommand_SubscribeToOnlines_ struct {
	SubscribeToOnlines *WeakUpdateCommand_SubscribeToOnlines `protobuf:"bytes,2,opt,name=subscribe_to_onlines,json=subscribeToOnlines,proto3,oneof" json:"subscribe_to_onlines,omitempty"`
}
...
func (*WeakUpdateCommand_SubscribeToOnlines_) isWeakUpdateCommand_Command()       {}
...
func (m *WeakUpdateCommand) GetSubscribeToOnlines() *WeakUpdateCommand_SubscribeToOnlines {
	if x, ok := m.GetCommand().(*WeakUpdateCommand_SubscribeToOnlines_); ok {
...
func (*WeakUpdateCommand) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*WeakUpdateCommand_SubscribeToOnlines_)(nil),
...
func (m *WeakUpdateCommand_ChangeMyOnline) GetTimeout() int64 {
	if m != nil {
		return m.Timeout
	}
	return 0
...
func (m *WeakUpdateCommand_ChangeMyOnline) GetDeviceType() DeviceType {
	if m != nil {
		return m.DeviceType
	}
...
type WeakUpdateCommand_SubscribeToOnlines struct {
	Peers       *PeersList `protobuf:"bytes,1,opt,name=peers,proto3" json:"peers,omitempty"`
	SendUsersId bool       `protobuf:"varint,2,opt,name=send_users_id,json=sendUsersId,proto3" json:"send_users_id,omitempty"`
}

func (m *WeakUpdateCommand_SubscribeToOnlines) Reset()      { *m = WeakUpdateCommand_SubscribeToOnlines{} }
func (*WeakUpdateCommand_SubscribeToOnlines) ProtoMessage() {}
func (*WeakUpdateCommand_SubscribeToOnlines) Descriptor() ([]byte, []int) {
	return fileDescriptor_0cf1109f6bcc730b, []int{25, 1}
}
func (m *WeakUpdateCommand_SubscribeToOnlines) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *WeakUpdateCommand_SubscribeToOnlines) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_WeakUpdateCommand_SubscribeToOnlines.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *WeakUpdateCommand_SubscribeToOnlines) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WeakUpdateCommand_SubscribeToOnlines.Merge(m, src)
}
func (m *WeakUpdateCommand_SubscribeToOnlines) XXX_Size() int {
	return m.Size()
}
func (m *WeakUpdateCommand_SubscribeToOnlines) XXX_DiscardUnknown() {
	xxx_messageInfo_WeakUpdateCommand_SubscribeToOnlines.DiscardUnknown(m)
}

var xxx_messageInfo_WeakUpdateCommand_SubscribeToOnlines proto.InternalMessageInfo

func (m *WeakUpdateCommand_SubscribeToOnlines) GetPeers() *PeersList {
	if m != nil {
		return m.Peers
	}
	return nil
...
func (m *WeakUpdateCommand_SubscribeToOnlines) GetSendUsersId() bool {
	if m != nil {
		return m.SendUsersId
	}
	return false
...
func (*WeakUpdateCommand_ChangeMyTyping) Descriptor() ([]byte, []int) {
	return fileDescriptor_0cf1109f6bcc730b, []int{25, 2}
}
...
type WeakUpdateBox struct {
	...
	//	*WeakUpdateBox_UserOnline
	//	*WeakUpdateBox_GroupTyping
	//	*WeakUpdateBox_MiniApp
	//	*WeakUpdateBox_Event
...
type WeakUpdateBox_Typing struct {
	Typing *UpdateTyping `protobuf:"bytes,1,opt,name=typing,proto3,oneof" json:"typing,omitempty"`
}
...
type WeakUpdateBox_UserOnline struct {
	UserOnline *UpdateUserOnline `protobuf:"bytes,14,opt,name=user_online,json=userOnline,proto3,oneof" json:"user_online,omitempty"`
}
type WeakUpdateBox_GroupTyping struct {
	GroupTyping *UpdateGroupTyping `protobuf:"bytes,15,opt,name=group_typing,json=groupTyping,proto3,oneof" json:"group_typing,omitempty"`
}
type WeakUpdateBox_MiniApp struct {
	MiniApp *UpdateMiniApp `protobuf:"bytes,16,opt,name=mini_app,json=miniApp,proto3,oneof" json:"mini_app,omitempty"`
}
type WeakUpdateBox_Event struct {
	Event *UpdateEvent `protobuf:"bytes,17,opt,name=event,proto3,oneof" json:"event,omitempty"`
}

func (*WeakUpdateBox_Typing) isWeakUpdateBox_Updatebox()                {}
...
func (*WeakUpdateBox_UserOnline) isWeakUpdateBox_Updatebox()            {}
func (*WeakUpdateBox_GroupTyping) isWeakUpdateBox_Updatebox()           {}
func (*WeakUpdateBox_MiniApp) isWeakUpdateBox_Updatebox()               {}
func (*WeakUpdateBox_Event) isWeakUpdateBox_Updatebox()                 {}
...
func (m *WeakUpdateBox) GetTyping() *UpdateTyping {
	if x, ok := m.GetUpdatebox().(*WeakUpdateBox_Typing); ok {
		return x.Typing
	}
	return nil
}
...
func (m *WeakUpdateBox) GetUserOnline() *UpdateUserOnline {
	if x, ok := m.GetUpdatebox().(*WeakUpdateBox_UserOnline); ok {
		return x.UserOnline
	}
	return nil
}

func (m *WeakUpdateBox) GetGroupTyping() *UpdateGroupTyping {
	if x, ok := m.GetUpdatebox().(*WeakUpdateBox_GroupTyping); ok {
		return x.GroupTyping
	}
	return nil
}

func (m *WeakUpdateBox) GetMiniApp() *UpdateMiniApp {
	if x, ok := m.GetUpdatebox().(*WeakUpdateBox_MiniApp); ok {
		return x.MiniApp
	}
	return nil
}

func (m *WeakUpdateBox) GetEvent() *UpdateEvent {
	if x, ok := m.GetUpdatebox().(*WeakUpdateBox_Event); ok {
		return x.Event
	}
	return nil
}
...
func (*WeakUpdateBox) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*WeakUpdateBox_UserOnline)(nil),
		(*WeakUpdateBox_GroupTyping)(nil),
		(*WeakUpdateBox_MiniApp)(nil),
		(*WeakUpdateBox_Event)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*WeakUpdateCommand_SubscribeToOnlines)(nil), "dialog.WeakUpdateCommand.SubscribeToOnlines")
...
var fileDescriptor_0cf1109f6bcc730b = []byte{
	...
	,
}
...
func (this *UpdateSeqUpdate_UpdateGroupTyping) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UpdateSeqUpdate_UpdateGroupTyping)
	if !ok {
		that2, ok := that.(UpdateSeqUpdate_UpdateGroupTyping)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.UpdateGroupTyping.Equal(that1.UpdateGroupTyping) {
		return false
	}
	return true
}
func (this *UpdateSeqUpdate_UpdateDialogReadLaterChanged) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UpdateSeqUpdate_UpdateDialogReadLaterChanged)
	if !ok {
		that2, ok := that.(UpdateSeqUpdate_UpdateDialogReadLaterChanged)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.UpdateDialogReadLaterChanged.Equal(that1.UpdateDialogReadLaterChanged) {
		return false
	}
	return true
}
...
func (this *RequestSubscribeToGroupOnline) Equal(that interface{}) bool {
	...
	if this.SendUsersId != that1.SendUsersId {
		return false
	}
	return true
}
...
func (this *WeakUpdateCommand_SubscribeToOnlines_) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*WeakUpdateCommand_SubscribeToOnlines_)
	if !ok {
		that2, ok := that.(WeakUpdateCommand_SubscribeToOnlines_)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *WeakUpdateCommand_SubscribeToOnlines) Equal(that interface{}) bool {
	...
	if !this.Peers.Equal(that1.Peers) {
		return false
	}
	if this.SendUsersId != that1.SendUsersId {
		return false
...
func (this *WeakUpdateBox_Typing) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*WeakUpdateBox_Typing)
	if !ok {
		that2, ok := that.(WeakUpdateBox_Typing)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *WeakUpdateBox_UserOnline) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*WeakUpdateBox_UserOnline)
	if !ok {
		that2, ok := that.(WeakUpdateBox_UserOnline)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.UserOnline.Equal(that1.UserOnline) {
		return false
	}
	return true
}
func (this *WeakUpdateBox_GroupTyping) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*WeakUpdateBox_GroupTyping)
	if !ok {
		that2, ok := that.(WeakUpdateBox_GroupTyping)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.GroupTyping.Equal(that1.GroupTyping) {
		return false
	}
	return true
}
func (this *WeakUpdateBox_MiniApp) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*WeakUpdateBox_MiniApp)
	if !ok {
		that2, ok := that.(WeakUpdateBox_MiniApp)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.MiniApp.Equal(that1.MiniApp) {
		return false
	}
	return true
}
func (this *WeakUpdateBox_Event) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*WeakUpdateBox_Event)
	if !ok {
		that2, ok := that.(WeakUpdateBox_Event)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *UpdateSeqUpdate_UpdateGroupTyping) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dialog.UpdateSeqUpdate_UpdateGroupTyping{` +
		`UpdateGroupTyping:` + fmt.Sprintf("%#v", this.UpdateGroupTyping) + `}`}, ", ")
	return s
}
func (this *UpdateSeqUpdate_UpdateDialogReadLaterChanged) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dialog.UpdateSeqUpdate_UpdateDialogReadLaterChanged{` +
		`UpdateDialogReadLaterChanged:` + fmt.Sprintf("%#v", this.UpdateDialogReadLaterChanged) + `}`}, ", ")
	return s
}
...
func (this *RequestSubscribeToGroupOnline) GoString() string {
	...
	s = append(s, "SendUsersId: "+fmt.Sprintf("%#v", this.SendUsersId)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *WeakUpdateCommand_SubscribeToOnlines_) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dialog.WeakUpdateCommand_SubscribeToOnlines_{` +
...
func (this *WeakUpdateCommand_SubscribeToOnlines) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&dialog.WeakUpdateCommand_SubscribeToOnlines{")
	if this.Peers != nil {
		s = append(s, "Peers: "+fmt.Sprintf("%#v", this.Peers)+",\n")
	}
	s = append(s, "SendUsersId: "+fmt.Sprintf("%#v", this.SendUsersId)+",\n")
...
func (this *WeakUpdateBox_Typing) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dialog.WeakUpdateBox_Typing{` +
...
func (this *WeakUpdateBox_UserOnline) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dialog.WeakUpdateBox_UserOnline{` +
		`UserOnline:` + fmt.Sprintf("%#v", this.UserOnline) + `}`}, ", ")
	return s
}
func (this *WeakUpdateBox_GroupTyping) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dialog.WeakUpdateBox_GroupTyping{` +
		`GroupTyping:` + fmt.Sprintf("%#v", this.GroupTyping) + `}`}, ", ")
	return s
}
func (this *WeakUpdateBox_MiniApp) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dialog.WeakUpdateBox_MiniApp{` +
		`MiniApp:` + fmt.Sprintf("%#v", this.MiniApp) + `}`}, ", ")
	return s
}
func (this *WeakUpdateBox_Event) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dialog.WeakUpdateBox_Event{` +
...
func (m *UpdateSeqUpdate_UpdateGroupTyping) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateSeqUpdate_UpdateGroupTyping) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UpdateGroupTyping != nil {
		{
			size, err := m.UpdateGroupTyping.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *UpdateSeqUpdate_UpdateDialogReadLaterChanged) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateSeqUpdate_UpdateDialogReadLaterChanged) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UpdateDialogReadLaterChanged != nil {
		{
			size, err := m.UpdateDialogReadLaterChanged.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *WeakUpdateCommand_SubscribeToOnlines_) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WeakUpdateCommand_SubscribeToOnlines_) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *WeakUpdateCommand_ChangeMyOnline) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.DeviceType != 0 {
		i = encodeVarintSequenceAndUpdates(dAtA, i, uint64(m.DeviceType))
		i--
		dAtA[i] = 0x18
	}
	if m.Timeout != 0 {
		i = encodeVarintSequenceAndUpdates(dAtA, i, uint64(m.Timeout))
		i--
		dAtA[i] = 0x10
	}
	if m.Online {
...
func (m *WeakUpdateCommand_SubscribeToOnlines) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *WeakUpdateBox_Typing) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WeakUpdateBox_Typing) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Typing != nil {
		{
...
func (m *WeakUpdateBox_UserOnline) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WeakUpdateBox_UserOnline) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UserOnline != nil {
		{
			size, err := m.UserOnline.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *WeakUpdateBox_GroupTyping) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WeakUpdateBox_GroupTyping) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.GroupTyping != nil {
		{
			size, err := m.GroupTyping.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *WeakUpdateBox_MiniApp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WeakUpdateBox_MiniApp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.MiniApp != nil {
		{
			size, err := m.MiniApp.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *WeakUpdateBox_Event) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WeakUpdateBox_Event) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Event != nil {
		{
...
func (m *UpdateSeqUpdate_UpdateGroupTyping) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.UpdateGroupTyping != nil {
		l = m.UpdateGroupTyping.Size()
		n += 2 + l + sovSequenceAndUpdates(uint64(l))
	}
	return n
}
func (m *UpdateSeqUpdate_UpdateDialogReadLaterChanged) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.UpdateDialogReadLaterChanged != nil {
		l = m.UpdateDialogReadLaterChanged.Size()
		n += 2 + l + sovSequenceAndUpdates(uint64(l))
	}
	return n
}
...
func (m *WeakUpdateCommand_SubscribeToOnlines_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *WeakUpdateCommand_ChangeMyOnline) Size() (n int) {
	...
	if m.Timeout != 0 {
		n += 1 + sovSequenceAndUpdates(uint64(m.Timeout))
	}
	if m.DeviceType != 0 {
		n += 1 + sovSequenceAndUpdates(uint64(m.DeviceType))
	}
	return n
}
...
func (m *WeakUpdateBox_Typing) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *WeakUpdateBox_UserOnline) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *WeakUpdateBox_GroupTyping) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.GroupTyping != nil {
		l = m.GroupTyping.Size()
		n += 1 + l + sovSequenceAndUpdates(uint64(l))
	}
	return n
}
func (m *WeakUpdateBox_MiniApp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *WeakUpdateBox_Event) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *UpdateSeqUpdate_UpdateGroupTyping) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateSeqUpdate_UpdateGroupTyping{`,
		`UpdateGroupTyping:` + strings.Replace(fmt.Sprintf("%v", this.UpdateGroupTyping), "UpdateGroupTyping", "UpdateGroupTyping", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UpdateSeqUpdate_UpdateDialogReadLaterChanged) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateSeqUpdate_UpdateDialogReadLaterChanged{`,
		`UpdateDialogReadLaterChanged:` + strings.Replace(fmt.Sprintf("%v", this.UpdateDialogReadLaterChanged), "UpdateDialogReadLaterChanged", "UpdateDialogReadLaterChanged", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *RequestSubscribeToGroupOnline) String() string {
	...
	s := strings.Join([]string{`&RequestSubscribeToGroupOnline{`,
		`Groups:` + repeatedStringForGroups + `,`,
		`SendUsersId:` + fmt.Sprintf("%v", this.SendUsersId) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *WeakUpdateCommand_SubscribeToOnlines_) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&WeakUpdateCommand_SubscribeToOnlines_{`,
		`SubscribeToOnlines:` + strings.Replace(fmt.Sprintf("%v", this.SubscribeToOnlines), "WeakUpdateCommand_SubscribeToOnlines", "WeakUpdateCommand_SubscribeToOnlines", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *WeakUpdateCommand_SubscribeToOnlines) String() string {
	...
	s := strings.Join([]string{`&WeakUpdateCommand_SubscribeToOnlines{`,
		`Peers:` + strings.Replace(this.Peers.String(), "PeersList", "PeersList", 1) + `,`,
		`SendUsersId:` + fmt.Sprintf("%v", this.SendUsersId) + `,`,
		`}`,
	}, "")
	return s
...
func (this *WeakUpdateBox_Typing) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&WeakUpdateBox_Typing{`,
		`Typing:` + strings.Replace(fmt.Sprintf("%v", this.Typing), "UpdateTyping", "UpdateTyping", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *WeakUpdateBox_UserOnline) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&WeakUpdateBox_UserOnline{`,
		`UserOnline:` + strings.Replace(fmt.Sprintf("%v", this.UserOnline), "UpdateUserOnline", "UpdateUserOnline", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *WeakUpdateBox_GroupTyping) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&WeakUpdateBox_GroupTyping{`,
		`GroupTyping:` + strings.Replace(fmt.Sprintf("%v", this.GroupTyping), "UpdateGroupTyping", "UpdateGroupTyping", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *WeakUpdateBox_MiniApp) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&WeakUpdateBox_MiniApp{`,
		`MiniApp:` + strings.Replace(fmt.Sprintf("%v", this.MiniApp), "UpdateMiniApp", "UpdateMiniApp", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *WeakUpdateBox_Event) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&WeakUpdateBox_Event{`,
		`Event:` + strings.Replace(fmt.Sprintf("%v", this.Event), "UpdateEvent", "UpdateEvent", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *UpdateSeqUpdate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 102:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdateGroupTyping", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Update = &UpdateSeqUpdate_UpdateGroupTyping{v}
			iNdEx = postIndex
		case 103:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdateDialogReadLaterChanged", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &UpdateDialogReadLaterChanged{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Update = &UpdateSeqUpdate_UpdateDialogReadLaterChanged{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *RequestSubscribeToGroupOnline) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SendUsersId", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *WeakUpdateCommand) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			v := &WeakUpdateCommand_SubscribeToOnlines{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Command = &WeakUpdateCommand_SubscribeToOnlines_{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *WeakUpdateCommand_SubscribeToOnlines) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SubscribeToOnlines: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SubscribeToOnlines: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *WeakUpdateBox) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Updatebox = &WeakUpdateBox_Typing{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UserOnline", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Updatebox = &WeakUpdateBox_UserOnline{v}
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GroupTyping", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Updatebox = &WeakUpdateBox_GroupTyping{v}
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MiniApp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Updatebox = &WeakUpdateBox_MiniApp{v}
			iNdEx = postIndex
		case 17:
			if wireType != 2 {
			...
			m.Updatebox = &WeakUpdateBox_Event{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSequenceAndUpdates(dAtA[iNdEx:])
